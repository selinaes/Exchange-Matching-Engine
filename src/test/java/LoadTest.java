...
//  public static final int MaxBytes = 10000;
  ...
  private void sendCreateRequest(Map<String, Double> create, Map<String, Map<String, Double>> positions, UserController client) {
...
//    client.stopConnection();
  ...
  public void sendTransaction(String accountId, List<SubTransactionRequest> subTransactionRequests, UserController client) {
//    UserController client = new UserController();
//    client.startConnection("localhost", 12345);
    StringBuilder sb = new StringBuilder();
    sb.append("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n");
...
//    client.sendMessage(sb.toString());
  ...
  public void testLoad() {
    ...
    for (int i = 0; i < numRounds; i++) {
      ...
      for (int j = 1; j < 11; j++) {
        requestStartTime = System.nanoTime();
        sendTransaction(String.valueOf(j), subTrans.get(j-1), client);
        numRequests++;
        client.recvMsg();
        requestEndTime = System.nanoTime();
        latencyMs = (requestEndTime - requestStartTime) / 1000000;
  ...
  @Test
  public void testCreate(UserController client) {
    ...
    sendCreateRequest(create, positions, client);
  }
...
//      sendTransaction(String.valueOf(i), orders);
  ...
  @Test
  public void testMultipleCreate(UserController client) {
    ...
    for (int i = 1; i < numIteration; i++) {
      sendCreateRequest(Map.of(String.valueOf(i),
              ...
              (double) i * 1000)), client);
    }
  }

  @Test
  public void testTrans(UserController client) {
    ...
    sendTransaction("1", subTransactionRequests, client);
  }
}
